...
def run_integration_test() -> None:
    ...
    with grpc.insecure_channel("server_a:50051") as channel:
        ...
        assert response.success, "Camera disable should succeed regardless of USB status."
        time.sleep(2)
        ...
        logger.info(f"Result: {response.success} | {response.message}")
        assert not response.success, "Door unlock should fail without USB override."
        time.sleep(2)
        ...
        logger.info(f"Result: {response.success} | {response.message}")
        assert response.success, "USB plug-in should succeed."
        time.sleep(2)
        ...
        response = stub.unlockDoor(door_req)
        logger.info(f"Result: {response.success} | {response.message}")
        assert response.success, "Door unlock should succeed with USB override."
        time.sleep(2)
        ...
        logger.info(f"Result: {response.success} | {response.message}")
        assert not response.success, "Vault door unlock should fail without USB override."
